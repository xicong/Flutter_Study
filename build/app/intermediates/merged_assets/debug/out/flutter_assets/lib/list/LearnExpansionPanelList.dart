...
class _LearnExpansionPanelList extends State<LearnExpansionPanelList>{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: CommTitle.setMaterialAppBar(context, "ExpansionPanelList",new Callback(
        codeOnTap: (){
          CodePreview.go(context, "ExpansionPanelList", "lib/list/LearnExpansionPanelList.dart");
        }
      )),
