...
articleListEntityFromJson(ArticleListEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = ArticleListData().fromJson(json['data']);
	}
...
articleListDataFromJson(ArticleListData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => ArticleListDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
articleListDataDatasFromJson(ArticleListDataDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> articleListDataDatasToJson(ArticleListDataDatas entity) {
	final Map<String, dynamic> data = Map<String, dynamic>();
