  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new ListView(
        children: <Widget>[
          //设计风格
            CommListItem.setMaterialListItem(context,"MaterialApp","Android的Material设置风格", new LearnMaterialApp()),
            CommListItem.setMaterialListItem(context,"CupertinoApp","ios的Cupertino设置风格", new LearnCupertinoApp()),
        ],
      ),
    );
  }
